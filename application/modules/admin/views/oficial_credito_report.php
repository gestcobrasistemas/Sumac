...
<script>
    ...
    function moreActionsOficial( index, row ) {
        var html = [];
        var id = row['id'];
        var cambiarClave = '<a id="call-php" class="" href="#" data-target="messagesout" php-function="<?= base_url() ?>modal/admin__oficialcredito__open_view__'+id+'/0/0">Cambiar Clave o Subir Foto de perfil</a>';
