...
class Index extends MX_Controller {
	...
	function __construct()
	{
		...
		//-----------alertas de volver a llamar
		public function volver_llamar() {
            $res['menu'] = array(
                    array( 'Alertas de volver a llamar', 'icon-envelope'),
                    
                );
            $res['content_menu'] = array(                
                    array('alertas_report', 'Revisar alertas de Volver a Llamar', array( 'id'=>$this->user->company_id)),
                );
