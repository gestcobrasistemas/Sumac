...
-->
    ...
    <div class="handsontable" id="example">       
        <table id="table_credits" 
               ...
               data-url="<?= base_url('cobranzas/credit/get_credit_detail_of/' . $client_id. '/' .urlencode(serialize($oficial))) ?>"
               data-sort-name="id"
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th data-field="cliente" data-visible="true" data-filter-control="input">No Socio</th>
                    <?php
                    if ($show_export == 1) {
                        ?>
