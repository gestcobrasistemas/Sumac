    ...
    <table id="table_contact"
        ...
        >   
            ...
            <tr>
			   ...
			   <th data-field="respuesta_name" data-sortable='true' data-formatter="formatContactType_1" data-filter-control="input" >Respuesta</th>
            </tr>
            </thead>
        </table>    
</div>
...
<script>
    ...
    function editCompany( index, row ) {
	   ...
	   function formatContactType_1(index, row) {
           var reference_type_id = row['contact_respuesta_id'];
           var selected = '';
           var role = "<select class=' select2able'  name='contact_respuesta_id[]'>";
        <?php
        $respuesta = (new \gestcobra\contact_respuesta_model())
        ...
        foreach ($respuesta as $value) {
            ?>
                    ...
                    role += "<option "+selected+" value='<?= $value->id ?>'><?= $value->respuesta_name ?></option>";
