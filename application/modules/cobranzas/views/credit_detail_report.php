...
<!--
        <div class="col-md-2">
            <select class=' select2able' name='notif_id[]'>
                <option  value='-1'>Selec.Oficial</option>
-->
            <?php
			if($this->user->role_id == 1 OR $this->user->role_id == 2){
        $oficial_credito_model = (new \gestcobra\oficial_credito_model())
        ...
        $combo_oficial_credito_model = combobox(
                $oficial_credito_model, 
                array('value' => 'id', 'label' => 'email'), 
                array('class' => 'form-control select2able', 'name' => 'oficial_credito_model[]', 'multiple' => ''),
                false, '3'
        );
		?>
		<div class="col-md-1">
            <h4>Seleccionar Oficial</h4>
        </div>
        <div class="col-md-3">
            <?php echo $combo_oficial_credito_model ?>
        </div>
		<div class="col-md-1">
            <button type="button" id="Seleccionar" class="btn btn-primary pull-right" name="notification_id" value="of" style="font-size: 15px" onclick="this.form.action='<?= base_url('credit_details_of.jsp/') ?>';this.form.submit();">Filtrar Oficial</button>
        </div>
		...
		$oficina_company_model = (new \gestcobra\oficina_company_model())
				-> where ('status', 1)
				->find();
        $combo_oficina_company_model = combobox(
                $oficina_company_model, 
                array('value' => 'id', 'label' => 'name'), 
                array('class' => 'form-control select2able', 'name' => 'oficina_company_model[]', 'multiple' => ''),
                false, '3'
        );
		?>
		<div class="col-md-1">
            <h4>Seleccionar Agencia</h4>
        </div>
        <div class="col-md-3">
            <?php echo $combo_oficina_company_model ?>
        </div>
		<div class="col-md-1">
            <button type="button" id="Seleccionar" class="btn btn-primary pull-right" name="notification_id" value="of" style="font-size: 15px" onclick="this.form.action='<?= base_url('credit_details_ag.jsp/') ?>';this.form.submit();">Filtrar Agencia</button>
        </div>
		<?php
		}
		?>
        ...
        <div class="col-md-4">
            <?php echo $combo_reference_type_model ?>
                ...
                <hr class="clr"/>
			<button class="btn btn-primary" reset-form="0" id="autosubmit_edit_template" data-target="#response" onclick="this.form.action='<?= base_url('msjs/subir_mensajes/leer1')?>';">Visualizar mensaje</button>
			
                <div class="col-md-12" id="response"></div>

        <div class="form-group">
            <button type="button" reset-form="0" id="autosubmit" class="btn btn-primary pull-right" name="notification_id" value="com_masiva" style="font-size: 15px"  onclick="this.form.action='<?= base_url('admin/notificationformat/notification_print/0')?>';"  ><i class="icon-ok"></i>&nbsp;NOTIFICAR</button>            
        </div>
-->
            ...
            <thead>
                ...
                <tr>
                    ...
                    if ($show_export == 1) {
                        ...
                        <th data-field="status_name" data-sortable="true" data-cell-style="cellStyle" data-filter-control="input">Estado Gestion</th>
                        <?php
                    } else {
                        ?>
                    ...
                    <th data-field="nro_pagare" data-visible="true" data-filter-control="input">No Socio</th>
                    <?php
                    if ($show_export == 1) {
                        ?>
                        <th data-field="client_name" data-sortable="true" data-filter-control="input">Cliente</th>      
						<th data-field="fecha_ultima_gestion" data-sortable="true" data-filter-control="input">Fecha Ult. Gest</th> 
                        <!--<th data-field="personal_address" data-visible="false" data-filter-control="input">Direccion</th>-->   
                        ...
                        <th data-field="saldo_actual" data-visible="true" data-sortable="true" data-filter-control="input">Valor a Pagar</th>
                        <th data-field="dias_mora" data-visible="true" data-sortable="true" data-filter-control="input" >Dias mora</th> 
                        <th data-field="cuotas_mora" data-visible="true" data-sortable="true" data-filter-control="input">Cuot. Vencidas</th> 
                        <th data-field="total_cuotas_vencidas" data-visible="true" data-sortable="true" data-filter-control="input">Saldo tot</th>
                        <th data-field="cuotas_pagadas" data-visible="false" data-sortable="true" data-filter-control="input">Riesgo</th>                  
						...
						<th data-field="email" data-visible="false" data-sortable="true" data-filter-control="input">Oficial</th>
                        ...
                        <th data-field="saldo_actual" data-sortable="true" data-filter-control="input">Valor a pagar</th>
                        <th data-field="dias_mora" data-visible="true" data-sortable="true" data-filter-control="input">Dias mora</th> 
                        <th data-field="cuotas_mora" data-visible="true" data-sortable="true" data-filter-control="input">Cuot. Vencidas</th> 
                        <th data-field="total_cuotas_vencidas" data-visible="true" data-sortable="true" data-filter-control="input">Saldo tot</th>
                        <th data-field="cuotas_pagadas" data-visible="true" data-filter-control="input">Riesgo</th>                  
