...
$combo_motivo_no_pago = combobox(
        $motivo_no_pago, array('label' => 'motivo_name', 'value' => 'id'), array('name' => 'motivo_no_pago_id', 'class' => 'form-control'), false, $ml_motivo_no_pago_model->motivo_no_pago_id
);
...
?>
 ...
 <div class="col-md-2" >
    <style>.datepicker{z-index:1200 !important;}</style>
            <input id="datepicker1" class="form-control datepicker" onkeydown="return false" data-date-autoclose="true" type="text" name="fecha_llamar"  value=""  placeholder="2022-11-02" />
            <script type="text/javascript">
            var myDate = new Date();
...
<strong class="col-md-1">Valor promesa de Pago:</strong>
        <div class="col-md-2">
            <input class="form-control" id="promesa" type="number" name="promesa" maxlength="40" value="1"  placeholder="Valor promesa de pago" /> 
        </div>
    </div>
...
$this->load->view('cuotas_1', array('client_id' => $ml_credit_detail_model->nro_pagare, 'data_height' => '150', 'show_export' => 0, 'compromiso_pago_date' => '0'));
?>
