...
<!--
        ...
        <div class="form-group">
            <button type="button" id="autosubmit" class="btn btn-primary pull-right" name="notification_id" value="com_masiva" style="font-size: 15px" onclick="this.form.action='<?= base_url('admin/notificationformat/notification_print/0')?>' ><i class="icon-ok"></i>&nbsp;NOTIFICAR</button>            
        </div>
...
-->
    ...
    if ($show_export == 1) {
    ?>          
    <a class="btn btn-success btn-xs" href="<?= base_url('credit_details.jsp/' ) ?>">Quitar Filtro</a>             
...
<!--       <div class="btn-group" >
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"> FILTRO <span class="caret"></span></button>
             <ul class="dropdown-menu">
                <li><a href="credit_details.jsp">FILTRO</a></li>
                  </ul>
            </div>-->
    ...
    <div class="handsontable" id="example">       
        <table id="table_credits_f" 
               data-side-pagination="server"
               data-toggle="table_credits_f"
               data-height="<?php echo $data_height ?>"
               data-url="<?= base_url('cobranzas/credit/get_credit_detail_report_f/'. $client_id . '/'.$max.'/'.$min) ?>"
               data-sort-name="id"
            ...
            <thead>
                ...
                <tr>
                    ...
                    if ($show_export == 1) {
                        ...
                        <th data-field="cuotas_mora" data-visible="true" data-sortable="true" data-filter-control="input">Cuotas vencidas</th> 
                        <th data-field="total_cuotas_vencidas" data-visible="true" data-sortable="true" data-filter-control="input">Saldo total</th>
                        ...
                        <!--<th data-field="cedula_deudor" data-visible="false" data-filter-control="input">Cedula Deudor</th>-->
...
<script>  
    ...
    $('[data-toggle="table_credits_f"]').bootstrapTable();
    var $table = $('#table_credits_f');
