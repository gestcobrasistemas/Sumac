...
class Credit_detail_model_ag extends \CI_Model {
    
    private function _get_credit_detail_filter( $filter = null, $client_id,$ag) {
            ...
            $this -> db -> where_in('c_d.oficina_company_id',unserialize(urldecode(stripslashes($ag))));
            if($client_id>0){
        ...
        function get_credit_detail_data( $limit, $offset, $filter = null, $order_by = null, $client_id,$ag) {
            $this->_get_credit_detail_filter($filter, $client_id,$ag);
            $this->db->select(
        ...
        public function get_credit_detail_count( $filter = null, $client_id,$ag) {  
            $this->_get_credit_detail_filter($filter, $client_id,$ag);
