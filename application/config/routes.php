...
//----------------volver a llamar---
$route['volver_llamar.jsp'] = 'admin/index/volver_llamar';
$route['admin/index/volver_llamar'] = '';
...
$route['credit_details_of.jsp'] = "cobranzas/index/credit_details_of";
$route['credit_details_of.jsp/(:any)'] = "cobranzas/index/credit_details_of/$1";
$route['cobranzas/index/credit_details_of'] = '';

$route['credit_details_ag.jsp'] = "cobranzas/index/credit_details_ag";
$route['credit_details_ag.jsp/(:any)'] = "cobranzas/index/credit_details_ag/$1";
$route['cobranzas/index/credit_details_ag'] = '';

$route['credit_details_legal.jsp'] = "cobranzas/index/credit_details_legal";
$route['credit_details_legal.jsp/(:any)'] = "cobranzas/index/credit_details_legal/$1";
$route['cobranzas/index/credit_details_legal'] = '';
...
$route['reports/report_gestiones.jsp'] = "reports/index/report_by_gestiones";
$route['reports/index/report_by_gestiones'] = '';

$route['reports/report_general.jsp'] = "reports/index/report_by_general";
$route['reports/index/report_by_general'] = '';

$route['reports/report_producto.jsp'] = "reports/index/report_by_producto";
$route['reports/index/report_by_producto'] = '';
